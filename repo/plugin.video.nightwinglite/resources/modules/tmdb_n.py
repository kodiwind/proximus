...
#(f'https://api.themoviedb.org/3/movie/603?api_key=60fe3606be5342a8143b5428bc9e9d6e&language=en-US',verify=False).json()
...
def get_html_g():
    try:
        url_g=f'https://api.themoviedb.org/3/genre/tv/list?api_key=60fe3606be5342a8143b5428bc9e9d6e&language='+lang
        html_g_tv=get_html(url_g).json()
         
   
        url_g=f'https://api.themoviedb.org/3/genre/movie/list?api_key=60fe3606be5342a8143b5428bc9e9d6e&language='+lang
...
class tmdb:
    ...
    def build_data(self,url):
        ...
        all_urls = [f"https://api.themoviedb.org/3/%s/%s?api_key=60fe3606be5342a8143b5428bc9e9d6e&language=en&append_to_response=external_ids,videos,credits,release_dates,alternative_titles,translations"%(self.tv_movie,i['id']) for i in data['results']]
    ...
    def add_items(self,data_pre,tv_movie,order):
       try:
        ...
        url_params = 'plugin://plugin.video.nightwinglite/?' + urlencode(params) 
        self.all_d[id]={}
    ...
    def fix_data_season(self,data,html,order):
             ...
             if not stop_data:
                 ...
                 url=f'https://api.themoviedb.org/3/tv/%s/season/%s?api_key=60fe3606be5342a8143b5428bc9e9d6e&language=%s&append_to_response=external_ids'%(id,season,lang)

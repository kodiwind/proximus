...
from morbiusscrapers.modules.base import BaseDialog
...
class TextViewerXML(BaseDialog):
	...
	def set_properties(self):
		self.setProperty('morbiusscrapers.text', self.text)
		self.setProperty('morbiusscrapers.heading', self.heading)

...
from morbiusscrapers.modules.control import setting as getSetting, addonInfo
...
class source:
	...
	def __init__(self):
		...
		self.language = ['en']
		self.headers = {'user-agent': f"morbiusscrapers/{addonInfo('version')}", 'x-api-key': self.token}

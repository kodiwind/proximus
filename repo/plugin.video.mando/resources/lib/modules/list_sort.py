...
DEFAULT_SETTING_IDS = {'movies': 'mando.sort.default.movies', 'shows': 'mando.sort.default.shows'}
...
# ordered by it. lists_sort_order used int(get_setting('mando.sort.%s', '0')) -> code 0 (title), and
# tmdblists_sort_order used get_setting('mando.tmdbsort.%s', '4') -> code 4 (provider order). Reading

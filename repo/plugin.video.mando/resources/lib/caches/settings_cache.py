...
class SettingsCache:
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('mando.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('mando.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('mando.%s' % setting)])

def set_string(params):
	current_value = get_setting('mando.%s' % params['setting_id'])
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('mando.%s' % setting_id)
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_mando', 'setting_type': 'boolean', 'setting_default': 'false'},
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.mando/Movies Downloads/', 'browse_mode': '0'},

...
def window_manager(obj):
	def close():
		obj.close()
		kodi_utils.clear_property('mando.window_loaded')
		kodi_utils.clear_property('mando.window_stack')

	def monitor():
		timer = 0
		while not kodi_utils.get_property('mando.window_loaded') == 'true' and timer <= 5:
			kodi_utils.sleep(50)
			timer += 0.05
	...
	def get_stack():
		try: window_stack = json.loads(kodi_utils.get_property('mando.window_stack'))
		except: window_stack = []
		return window_stack

	def add_to_stack(params):
		window_stack.append(params)
		kodi_utils.set_property('mando.window_stack', json.dumps(window_stack))
...
class BaseDialog(xbmcgui.WindowXMLDialog):
	...
	def set_home_property(self, prop, value):
		kodi_utils.set_property('mando.%s' % prop, value)

	def get_home_property(self, prop):
		return kodi_utils.get_property('mando.%s' % prop)

	def clear_home_property(self, prop):
		return kodi_utils.clear_property('mando.%s' % prop)
...
class FontUtils:
	def execute_custom_fonts(self, skin_files=[]):
		...
		if not skin_files:
			kodi_utils.set_property('mando.current_skin', self.current_skin)
			kodi_utils.set_property('mando.current_font', self.current_font)
		skin_files = skin_files or kodi_utils.list_dirs(kodi_utils.translate_path('special://home/addons/plugin.video.mando/resources/skins/Default/1080i/'))[1]
	...
	def skin_change_check(self):
		...
		if self.current_skin != kodi_utils.get_property('mando.current_skin') or self.current_font != kodi_utils.get_property('mando.current_font'): return True
		return False
	...
	def replace_font(self, window, replacement_values):
		file = kodi_utils.translate_path('special://home/addons/plugin.video.mando/resources/skins/Default/1080i/' + window)
...
class ExtrasUtils:
	...
	def run(self):
		try:
			...
			file = kodi_utils.translate_path('special://home/addons/plugin.video.mando/resources/skins/Default/1080i/%s' % skin_file)
				...
				<control type="group">
				    ...
				    <control type="group">
				        ...
				        <control type="fixedlist" id="{container_no}">
				            ...
				            <itemlayout height="360" width="236">
				                <control type="image">
				                    ...
				                    <texture diffuse="mando_diffuse/poster-50.png" background="true">$INFO[ListItem.Property(thumbnail)]</texture>
				                </control>
				            </itemlayout>
				            <focusedlayout height="360" width="236">
				                <control type="image">
				                    ...
				                    <height>350</height>
				                    <width>236</width>
				                    <texture colordiffuse="FFCCCCCC">mando_diffuse/poster-50.png</texture>
				        ...
				        <control type="scrollbar" id="{scrollbar_no}">
				            ...
				            <texturesliderbackground colordiffuse="FF1F2020">mando_common/white.png</texturesliderbackground>
				            <texturesliderbar colordiffuse="FF555556">mando_common/white.png</texturesliderbar>
				            <texturesliderbarfocus colordiffuse="FFCCCCCC">mando_common/white.png</texturesliderbarfocus>
				        ...
				        <control type="image">
				            ...
				            <width>25</width>
				            <height>25</height>
				            <texture colordiffuse="CCCCCCCC" background="true">mando_common/arrow_left.png</texture>
				        ...
				        <control type="image">
				            ...
				            <width>25</width>
				            <height>25</height>
				            <texture colordiffuse="CCCCCCCC" background="true" flipx="true">mando_common/arrow_left.png</texture>
				        ...
				        <control type="panel" id="{container_no}">
				            ...
				            <itemlayout height="380" width="590">
				                <control type="image">
				                    <height>360</height>
				                    <width>580</width>
				                    <texture colordiffuse="$INFO[Window(10000).Property(mando.window_theme.extras)]" border="30">mando_common/circle.png</texture>
				                </control>
				            ...
				            <focusedlayout height="380" width="590">
				                <control type="image">
				                    <height>360</height>
				                    <width>580</width>
				                    <texture colordiffuse="FFCCCCCC" border="30">mando_common/circle.png</texture>
				                </control>
				                <control type="textbox">
				                    <top>15</top>
				                    <left>20</left>
...
<window>
    ...
    <controls>
        <control type="group">
            ...
            <height>1080</height>
            <control type="image">
                <texture colordiffuse="FF000000">mando_common/white.png</texture>
            </control>
        ...
        <control type="group">
            ...
            <control type="group">
                ...
                <control type="image">
                    ...
                    <texture>$INFO[Window(10000).Property(mando.addon_icon_mini)]</texture>
                </control>
                <control type="group">
                ...
                <control type="group">
                    ...
                    <control type="image">
                        ...
                        <height>35</height>
                        <aspectratio>keep</aspectratio>
                        <texture>mando_common/info.png</texture>
                        <visible>!String.IsEqual(ListItem.Property(info_alert),)</visible>
                    </control>
                    <control type="label">
            ...
            <control type="group">
                <control type="image" id="200">
                    ...
                    <height>1000</height>
                    <aspectratio>keep</aspectratio>
                    <texture diffuse="mando_diffuse/poster-50.png" background="true" />
                </control>
                <control type="group">
                    ...
                    <control type="group">
                        ...
                        <control type="group">
                            ...
                            <control type="image">
                                ...
                                <height>348</height>
                                <aspectratio>keep</aspectratio>
                                <texture diffuse="mando_diffuse/poster-50.png" background="true">$INFO[Window.Property(more_from_collection.poster)]</texture>
                            </control>
                            <control type="textbox">
                                <left>235</left>
                                <top>6</top>
                        ...
                        <control type="fixedlist" id="{container_no}">
                            ...
                            <itemlayout height="360" width="392">
                                <control type="image">
                                    ...
                                    <aspectratio>keep</aspectratio>
                                    <texture diffuse="mando_diffuse/landscape.png" background="true">$INFO[ListItem.Property(thumbnail)]</texture>
                                </control>
                            </itemlayout>
                            <focusedlayout height="360" width="392">
                                <control type="image">
                                    ...
                                    <height>296</height>
                                    <width>393</width>
                                    <texture colordiffuse="FFCCCCCC">mando_diffuse/landscape.png</texture>
                                    <visible>Control.HasFocus({container_no}) | Control.HasFocus({scrollbar_no})</visible>
                                </control>
                                <control type="image">
                                    <left>8</left>
                        ...
                        <control type="fixedlist" id="{container_no}">
                            ...
                            <itemlayout height="360" width="236">
                                ...
                                <control type="image">
                                    ...
                                    <width>50</width>
                                    <aspectratio>keep</aspectratio>
                                    <texture colordiffuse="red">mando_common/overlay_selected.png</texture>

...
class NavigatorCache:
	...
	{'name': 'People', 'mode': 'navigator.people', 'iconImage': 'people'},
	...
	def _get_list_prop(self, list_type):
		return {'default': 'morbius_%s_default', 'edited': 'morbius_%s_edited', 'shortcut_folder': 'morbius_%s_shortcut_folder'}[list_type]

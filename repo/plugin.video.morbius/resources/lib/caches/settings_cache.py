...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('morbius.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('morbius.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('morbius.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict.get(get_setting('morbius.%s' % setting), 'true'))

def set_string(params):
	current_value = get_setting('morbius.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('morbius.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('morbius.%s' % setting_id)
...
def default_setting_values(setting_id):
	if 'morbius.' in setting_id: setting_id = setting_id.replace('morbius.', '')
	d_settings = default_settings()
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_morbius', 'setting_type': 'boolean', 'setting_default': 'false'},
...
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'morbius', '1': 'Trakt', '2': 'Simkl', '3': 'MDBList'}},
#======+============= Trakt Cache
...
#======+============= MDBList Auth
{'setting_id': 'mdblist.api_key', 'setting_type': 'string', 'setting_default': ''},
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.morbius/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.morbius/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.morbius/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.morbius/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'morbius_icon_01'},
